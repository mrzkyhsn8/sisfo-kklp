...
<body class="text-center">
  ...
  <main class="form-signin">
    <form method="POST" id="formLogin">
      ...
      <b>
        <h1 class="h3 mb-3 fw-normal" style="color: black;">LOGIN</h1>
      </b>
    ...
    <div class="mt-2 mb-2">Belum Punya Akun ? <a href="#" data-bs-toggle="modal"
        data-bs-target="#addDataModal">Daftar</a></div>
  </main>
          ...
          <div class="form-group">
            ...
            <select name="id_kklp" id="penempatan" class="form-control show-tick">
              ...
              while ($kklp = mysqli_fetch_array($qry)) { ?>
                <option value="<?php echo $kklp['id'] ?>">
                  <?php echo $kklp['asal_instansi'] . " ( " . TanggalIndo($kklp['tgl_masuk']) . " - " . TanggalIndo($kklp['tgl_keluar']) . " )" ?>
                </option>
              <?php } ?>
            </select>
          </div>
