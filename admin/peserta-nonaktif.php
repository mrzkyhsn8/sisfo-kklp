                                                ...
                                                <td>
                                                  <ul class="list-inline m-0">
                                                    <li class="list-inline-item">
                                                      <a href="?page=peserta-selesai&id=<?php echo $data['id_kklp'] ?>" class="btn btn-secondary btn-sm rounded-3 mt-1"><i class="fa fa-user"></i> Detail Peserta</a>
                                                    </li>
                                                </ul>
                                                </td>
                                            </tr>
