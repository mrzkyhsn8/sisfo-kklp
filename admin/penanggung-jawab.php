                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h4 mb-0 text-gray-800 border-bottom">PENANGGUNG JAWAB</h1>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered mt-4 mb-4" width="100%" cellspacing="0">
                                        ...
                                        <?php
                                              ...
                                              $dt    = mysqli_query($mysqli, "SELECT * FROM tb_penanggung_jawab a left join tb_penempatan b on a.id_penempatan = b.id ");
                                                  ...
                                                  <form action="controller.php?page=penempatan&action=update" method="POST" enctype="multipart/form-data">
                                                    <div class="modal-body text-gray-900">
                                                      <div class="form-group">
                                                        <label for="data2">Nama Penanggunga Jawab</label>
                    ...
                    <div class="modal-content">
                      ...
                      <form action="controller.php?page=penempatan&action=insert" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="data2">NIP</label>
                            <input type="text" class="form-control" name="NIP" required="required">
                          </div>
                          <div class="form-group">
                            <label for="data2">Nama Penanggung Jawab</label>
                            <input type="text" class="form-control" name="nama_penanggung_jawab" required="required">
                          </div>
                        </div>
                        <div class="modal-footer border-top-0 d-flex justify-content-center">
                          <button class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
