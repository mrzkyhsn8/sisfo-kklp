    ...
    ?>
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h4 mb-0 text-gray-800 border-bottom">PESERTA AKTIF</h1>
                                                ...
                                                <td>
                                                  <ul class="list-inline m-0">
                                                    <li class="list-inline-item">
                                                      <a href="?page=peserta-detail-tempat&id=<?php echo $data['id_kklp'] ?>" class="btn btn-primary btn-sm rounded-3 mt-1"><i class="fa fa-user"></i> Detail Peserta</a>
                                                    </li>
                                                </ul>
                                                </td>
                                            </tr>
                                                  ...
                                                  <ol class="list-group d-flex">
                                                      <?php 
                                                        ...
                                                        while($peserta = mysqli_fetch_array($qry_pserta)){ ?>
                                                            <li class="list-group-item text-center"><a href="?page=laporan-peserta&id=<?php echo $peserta['id'] ?>"><?php echo $peserta['nama_lengkap']?></a></li>
                                                        <?php } ?>
                                                        </ol>
                                                  </div>
                                                </div>
